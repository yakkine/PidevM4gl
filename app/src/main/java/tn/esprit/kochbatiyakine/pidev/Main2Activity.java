...
ListView lv;
    ...
    lv=(ListView) findViewById(R.id.lv);
        ...
        JsonArrayRequest stringRequest=new JsonArrayRequest(Request.Method.GET, "http://10.0.2.2:18080/pidev-web/rest/mail/sent",null, new Response.Listener<JSONArray>() {
            @Override
            public void onResponse(JSONArray response) {

                Toast.makeText(Main2Activity.this, "yydyrdr", Toast.LENGTH_SHORT).show();
                try {
...
*/
                        m.put("email",String.valueOf(j.getJSONObject("receiver").getString("email")));
...
lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
    ...
    public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
        ...
        Toast.makeText(Main2Activity.this, "gsgsrgrrgsr", Toast.LENGTH_SHORT).show();
        Intent intent=new Intent(Main2Activity.this,SentDetailsActivity.class);
