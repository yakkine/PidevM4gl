...
public class ReceivedDetails extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        delete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                RequestQueue requestQueue= Volley.newRequestQueue(ReceivedDetails.this);
...
*/
                        Toast.makeText(ReceivedDetails.this,response,Toast.LENGTH_SHORT).show();
                        Intent i=new Intent(ReceivedDetails.this,Main2Activity.class);
                        startActivity(i);
